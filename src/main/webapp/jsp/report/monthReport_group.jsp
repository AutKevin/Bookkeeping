...
<head>
    ...
    <script>
        ...
        function getPie(time){
            /*获取种类*/
            $.ajax({
                url: '/${appName}/manager/reportController/getAllMonth_Year_group',
                type: 'post',
                async: 'true',
                cache: false,
                data: {time:time},
                ...
                success: function (monthdata) {
                    if (!isNull(monthdata)) {
                        /*获取数据*/
                        $.ajax({
                            url: '/${appName}/manager/reportController/getAllMonthMoney_Year_group',
                            type: 'post',
                            async: 'true',
                            cache: false,
                            data: {time:time,cateCode:cateCode_search},
                            dataType: 'json',
