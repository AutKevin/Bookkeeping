...
<html>
	<head>
		...
		<!--
			...
			.search_ul {position:absolute;left:0px}
		-->
		</style>
	</head>
						...
						<div class="ibox-title">
							<div class="row">
								<div class="col-sm-4">
									...
									<div class="col-sm-7 controls">
										<select onchange="changeSheBao('_search')" data-placeholder="请选择用户类型" class="form-control" tabindex="4" name="userType_search"
											id="userType_search">
								...
								<div class="col-sm-3 ">
									...
									<div class="input-group">
										<input type="text" class="form-control" placeholder="请输入账户名" id="name_search">
										<span class="input-group-btn">
											<button id="btn_search" disabled="disabled" type="button" class="btn btn-gmtx-define1" onclick="search()">
												搜索
											</button> </span>
									</div>
								</div>
								<div class="col-sm-1">
									<button class="btn btn-gmtx-define1" disabled="disabled" onclick="javascript:reset()" id="btn_reset">
										重置
									</button>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-1 col-md-offset-1">
									<button class="btn btn-gmtx-define1" disabled="disabled" data-toggle="modal" href="#addwin" data-keyboard="true" data-backdrop="false" id="btn_add">
										新增
									</button>
								</div>
								<div class="col-sm-1">
									<button class="btn btn-gmtx-define1" disabled="disabled" onclick="javascript:delUser()" id="btn_del">
										删除
									</button>
								</div>
							</div>
							...
							<form method="post" class="form-horizontal" id="addform">
								<div class="form-group">
									...
									<div class="col-sm-8 controls">
										<input type="text" value="" class="form-control" name="name" id="username_add" tabindex="1" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">
									...
									<div class="col-sm-8 controls">
										<input type="password" value="" class="form-control" name="psw" id="userpsw_add" tabindex="2" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">
									...
									<div class="col-sm-8 controls">
										<select onchange="changeSheBao('')" data-placeholder="请选择用户类型" class="form-control" tabindex="4" name="userType" id="userType">
											<option value="" hassubinfo="true">
												请选择
											</option>
											<option value="1" hassubinfo="true">
								...
								<div class="form-group">
									...
									<div class="col-sm-8 controls" style="position:relative">
										<div class="input-group search_div">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right search_ul" style="position:absolute;left:0px" role="menu">
                                            </ul>
	                                        <!--<div class="input-group-btn">
	                                            <button type="button" class="btn btn-white dropdown-toggle" data-toggle="dropdown">
	                                                <span class="caret"></span>
	                                            </button>
	                                            <ul class="dropdown-menu dropdown-menu-right ul_add" id="ul_add" role="menu">
	                                            </ul>
	                                        </div>
	                                    --></div>
										<!--<select data-placeholder="请选择单位" class="form-control" name="unitId" id="unitId" tabindex="3">
											<option value>
												请选择
											</option>
										</select>-->
			...
			<div class="modal-dialog" style="width: 400px">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="upwinlable">
							用户修改
						</h4>
					</div>
					<div class="modal-body">
						<div class="row">
							<form method="post" class="form-horizontal" id="upform">
								<div class="form-group">
									...
									<div class="col-sm-8 controls">
										<input type="text" value="" class="form-control" name="name" id="username_up" tabindex="1" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">
									...
									<div class="col-sm-8 controls">
										<select onchange="changeSheBao('_up')" data-placeholder="请选择用户类型" class="form-control" tabindex="4" name="userType" id="userType_up">
											<option value="" hassubinfo="true">
												请选择
											</option>
											<option value="1" hassubinfo="true">
								...
								<div class="form-group">
									...
									<div class="col-sm-8 controls">
										<div class="input-group search_div">
	                                        <input type="text" class="form-control search_unit" id="unitId_up" name="unitId">
										...
										<!-- <select data-placeholder="请选择单位" class="form-control" name="unitId" id="unitId_up" tabindex="3"></select> -->
									</div>
								</div>
						...
						<div class="row">
							<form method="post" class="form-horizontal" id="resetform">
								<div class="form-group">
									...
									<div class="col-sm-8 controls">
										<input type="text" value="" class="form-control" name="name" id="username_reset" disabled tabindex="1" />
									</div>
								</div>
								<!--<div class="form-group">
									<label class="col-sm-3 control-label">
									...
									<div class="col-sm-8 controls">
										<input type="password" value="" class="form-control" name="psw" id="psw_reset" tabindex="1" />
									</div>
								</div>-->
								<div class="form-group">
									<div class="controls">
						...
						<div class="row">
							<form method="post" class="form-horizontal" id="bindRoleform">
								<div class="form-group">
									...
									<div class="col-sm-8 controls">
										<input type="text" value="" class="form-control" name="name" id="username_bindRole" disabled tabindex="1" />
									</div>
								</div>
								<div class="form-group">
								<label class="col-sm-3 control-label">
								...
								<div class="form-group">
									<div class="controls">
										<button class="btn btn-gmtx-define1 center-block" onclick="javascript:bindRole();return false;">
											确定
										</button>
									</div>
								</div>
	...
	$(function(){
		...
		$("#unitId_search").bsSuggest('init', {
            clearable: true,
            url: "/${appName}/manager/CommonController/getUnitList",
            showBtn: false,  
            idField: "id",
            keyField: "name",
            effectiveFields: ["name","outside_code"],
            effectiveFieldsAlias: {"name":"机构名","outside_code":"编码"},
		...
		//loadUnit("/${appName}/manager/CommonController/getUnitList","unitId");
		//loadUnit("/${appName}/manager/CommonController/getUnitList","unitId_up");
		//loadUnit("/${appName}/manager/CommonController/getUnitList","unitId_search");
	    ...
	    url: "/${appName}/manager/userController/getAllUser",
	    method: 'post',
        ...
        columns: [
                ...
                },
                {
                    ...
                    formatter:function(value,row,index){
	                 //var e = '<a href="#" class="btn btn-gmtx-define1" onclick="edit(\''+ row.userCode +'\',\''+row.name+'\',\''+row.psw+'\',\''+row.unitId+'\',\''+row.userType+'\',\''+row.unitName+'\')">编辑</a> ';
	                 var d = '<a href="#" class="btn btn-gmtx-define1" onclick="resetPsw(\''+ row.id +'\',\''+row.usercode+'\')">重置密码</a> ';
	                 //var d = '<a href="#" class="btn btn-gmtx-define1" onclick="showResetPswWin(\''+ row.userCode +'\',\''+row.name+'\')">重置密码</a> '; 
	                 var f = '<a href="#" class="btn btn-gmtx-define1" onclick="bindRoleShow(\''+ row.id +'\',\''+row.usercode+'\')">角色分配</a> ';
                     return d+f;
                  	 }
                }
            ]
      ...
      function addUser(){
		...
		$.ajax({
			url:'/${appName}/manager/UserController/addUser',
			type:'post',
			async:'true',
			cache:false,
			data:{name:name,psw:psw,unitId:unitId,userType:userType},
			dataType:'json',
	  ...
	  function delUser(){
        ...
        for(var i = 1;i<selects.length;i++){
	  	...
	  	swal({
            ...
            if (isConfirm) {
                $.ajax({
					url:'/${appName}/manager/UserController/delUser',
					type:'post',
					async:'true',
					cache:false,
					data:{ids:ids},
		...
		function upUser(){
			...
			$.ajax({
			url:'/${appName}/manager/UserController/upUser',
			type:'post',
			async:'true',
			cache:false,
			data:{userCode:ucode_up,name:name,unitId:unitId,userType:userType},
			dataType:'json',
			success: function(data){
					  if(data.isExist){
					  	 swal({
		...
		//重置密码
		function resetPsw(uid,usercode){
        //var psw = $('#psw_reset').val();
	  	swal({
            ...
            if (isConfirm) {
                $.ajax({
					url:'/${appName}/manager/userController/upPswByAdmin',
					type:'post',
					async:'true',
					cache:false,
					data:{userId:uid,psw_new:usercode},
					dataType:'json',
					success: function(data){
							  if(data.success){
							        swal("您已重置密码！", "密码为登录账号名", "success");
							        $('#username_reset').val('');
							        $('#psw_reset').val('');
					         		$('#table').bootstrapTable("refresh");
				              }else{
		...
		//显示绑定角色窗口
		function bindRoleShow(id,userCode){
			/*取消勾选所有多选框*/
           	$("#roleAccess").find("input[type='checkbox']").each(function () {
			        $(this).prop('checked',false);
			});
			userCode_bindRole = id;
			$('#username_bindRole').val(userCode);   //弹框显示用户账号名
			/*获取指定用户的指定id绑定的角色*/
			$.ajax({
					url:'/${appName}/manager/roleController/getBindedRole',
					type:'post',
					async:false,
					cache:false,
					data:{id:userCode_bindRole},
					dataType:'json',
					success: function(data){
                        for(var i in data) {  //遍历json数组
                            $("#"+data[i].rolecode).prop("checked",true);  //将绑定的用户设为勾选状态
                        }
		...
		function bindRole(){
			...
			$.ajax({
					url:'/${appName}/manager/roleController/bindRole',
					type:'post',
					async:'true',
					cache:false,
					data:{userCode:userCode_bindRole,roleCodes:roles},
					dataType:'json',
					success: function(data){
							  if(data.success){
