...
<head>
    ...
    <link href="/${appName}/commons/jslib/hplus/css/login.min.css" rel="stylesheet">
	...
	body.signin {
		background:url(/${appName}/commons/images/login-background.jpg) no-repeat center fixed;
	} 
	.signinPanal{
		    width: 750px;
    		margin: 10% auto 0;
    ...
    .signinPanal .uname {
    	background: #fff url(/${appName}/commons/images/user.png) no-repeat 95% center;
    }
    .signinPanal .pword {
    	background: #fff url(/${appName}/commons/images/locked.png) no-repeat 95% center;
    }
	</style>
...
<body class="signin">
	<div class="signinPanal">
		<div style="position: absolute;  width: 306px; height: 313px; top: 0; right: 0; background: rgba(255,255,255,.2);    border: 1px solid rgba(255,255,255,.3) ">
			<form id='loginForm' method="post" action="/${appName}/manager/loginController/login">
				...
				<div style="position: absolute; width: 237px; height: 26px; z-index: 1; top: 28%; left: 13%;">
					 <input type="text" class="form-control uname" placeholder="用户名" name="usercode" id="userName" style="color:#030303;"/>
				</div>
				<div style="position: absolute; width: 237px; height: 26px; z-index: 2; top: 49%; left: 13%;">
					<input type="password" class="form-control pword m-b" placeholder="密码" name="pwd" id="pwd" style="color:#030303;"/>
				</div>
